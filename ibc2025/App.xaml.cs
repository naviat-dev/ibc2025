...
{
    public static List<Question>[] Questions = new List<Question>[5];
    public static int ActiveQuestion = 0;
    public static CategoryTypes Category;
    public static int[] TeamPts = [0, 0, 0, 0, 0, 0, 0, 0];
    public static int[] TeamPtsDsply = [0, 0, 0, 0, 0, 0, 0, 0];
    ...
    public void Start()
    {
        ...
        for (int categoryIndex = 0; categoryIndex < Questions.Length; categoryIndex++)
        {
    ...
    public static readonly string[] CategoryNames = ["Wisdom's True Ending", "Wisdom Applied", "Words Left Unspoken", "Wisdom Says", "Locate the Wisdom"];
}
